                            ...
                            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 md:gap-12">
                                <div className="max-w-4xl">
                                    ...
                                    <motion.h1
                                        ...
                                        className="text-[28px] md:text-[46px] lg:text-[58px] [@media(min-width:1600px)]:text-[60px] font-medium text-white mb-4 [@media(min-width:1600px)]:mb-6 leading-[1.15] tracking-[-0.015em]"
                                    >
                                    ...
                                    <motion.p
                                        ...
                                        className="text-sm md:text-base text-white/90 mb-6 [@media(min-width:1600px)]:mb-8 leading-relaxed font-normal max-w-3xl"
                                    >
