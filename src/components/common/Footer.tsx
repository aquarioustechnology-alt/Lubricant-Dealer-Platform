    ...
    return (
        <footer className="bg-gradient-to-b from-[#0066B2] to-[#0B2D71] text-white pt-24 pb-8 overflow-hidden relative">
            ...
            <div className="max-w-7.5xl [@media(min-width:1600px)]:max-w-8xl mx-auto px-6 md:px-12 lg:px-16 relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-10 mb-4 lg:mb-16">

                    {/* Brand Info */}
                    <div className="md:col-span-4 lg:col-span-4 space-y-6 lg:space-y-8">
                        <Image
                        ...
                        <div className="flex gap-4 pt-2 w-full lg:w-auto">
                            <button onClick={() => setLoginOpen(true)} className="flex-1 lg:flex-none btn-outline-white rounded-none w-full lg:w-auto justify-center">
                                Login
                            </button>
                            <button onClick={() => setSignUpOpen(true)} className="flex-1 lg:flex-none btn-fill-secondary rounded-none w-full lg:w-auto text-center justify-center">
                                Sign Up
                            </button>
                        </div>
                    ...
                    {footerLinks.map((group, i) => (
                        <div key={i} className="md:col-span-4 lg:col-span-2 border-b border-white/10 lg:border-none pb-4 lg:pb-0">
                            <button
                    ...
                    {/* Contact Info */}
                    <div className="md:col-span-4 lg:col-span-4 mt-2 lg:mt-0">
                        <button
                        ...
                        <div className={cn(
                            "lg:block overflow-hidden transition-all duration-300",
                            openMenu === "Contact" ? "max-h-[500px] opacity-100 mt-4" : "max-h-0 opacity-0 lg:max-h-[500px] lg:opacity-100 lg:mt-0"
                        )}>
                ...
                {/* Bottom Bar */}
                <div className="pt-6 lg:pt-8 border-t border-white/10 flex flex-col items-center justify-between gap-6 md:flex-row">
