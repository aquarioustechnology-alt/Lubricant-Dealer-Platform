                    ...
                    >
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="mb-10 text-center">
                                ...
                                <h2 className="text-2xl font-medium text-slate-900 mb-2 uppercase tracking-tight">Portal Login</h2>
                                ...
                                {step === 1 ? (
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-medium text-slate-400 uppercase tracking-widest block">Mobile Number</label>
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-slate-50 border border-slate-200 py-3.5 pl-14 pr-4 text-sm font-medium text-slate-900 focus:outline-none focus:border-primary transition-all rounded-none"
                                                />
                                            </div>
                                        </div>
                                        <button
                                        ...
                                        >
                                            <span className="relative z-10 flex items-center justify-center gap-3 font-medium text-[12px] tracking-widest">
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-2">
                                            <label className="text-[11px] font-medium text-slate-400 uppercase tracking-widest block">Verification Code</label>
                                            <div className="flex gap-2 justify-between">
                                                {[1, 2, 3, 4, 5, 6].map(i => (
                                                    <input
                                                        ...
                                                        type="text"
                                                        maxLength={1}
                                                        className="w-11 h-12 text-center bg-slate-50 border border-slate-200 text-lg font-medium text-slate-900 focus:outline-none focus:border-primary transition-all rounded-none"
                                                    />
                                                ))}
                                            </div>
                                            <div className="flex justify-between items-center mt-2">
                                                <span className="text-[11px] text-slate-400 font-medium">Didn&apos;t receive it?</span>
                                                <button className="text-[11px] text-primary font-medium hover:underline uppercase tracking-wider">Resend OTP</button>
                                            </div>
                                        </div>
                                        <button
                                        ...
                                        <button
                                            onClick={() => setStep(1)}
                                            className="w-full py-2 text-[11px] font-medium text-slate-400 hover:text-slate-600 transition-colors uppercase tracking-widest"
                                        >
                                            Change Number
                                        </button>
                                    </div>
                    ...
                    >
                        ...
                        <div className="p-8 md:p-12">
                            ...
                            <div className="mb-8 text-center">
                                <h2 className="text-2xl font-medium text-slate-900 mb-2 uppercase tracking-tight">Create Workspace</h2>
                            ...
                            <div className="flex border border-slate-100 mb-8 overflow-hidden">
                                <button
                                    ...
                                    className={cn(
                                        "flex-1 py-3 text-[11px] font-medium uppercase tracking-widest transition-all",
                            ...
                            <div className="space-y-5">
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest block">Full Name / Entity Name</label>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-slate-50 border border-slate-200 py-3 pl-11 pr-4 text-sm font-medium text-slate-900 focus:outline-none focus:border-primary transition-all rounded-none"
                                        />
                                    </div>
                                </div>

                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest block">Official Email</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-medium text-slate-400 uppercase tracking-widest block">Mobile Number</label>
                                    <div className="relative">
                                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400">
                            ...
                            <p className="mt-8 text-center text-[10px] text-slate-400 font-medium">
                                Already have an account? <button onClick={onClose} className="text-primary font-medium hover:underline">Sign In Instead</button>
                            </p>
                        </div>
                    </motion.div>
                </div>
